/** Same max-width + padding for header and sections so edges align at every breakpoint */
...
/** Header horizontal padding – use for hero/content that must align with header width */
