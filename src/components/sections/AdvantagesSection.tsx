    ...
    <section className="bg-white py-20">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Box 1: Title */}
          <div className="bg-primary p-8 rounded-2xl flex flex-col justify-center items-start text-white h-64">
            <div className="mb-4">
          ...
          {/* Box 3: Import Tax */}
          <div className="bg-primary p-8 rounded-2xl flex flex-col justify-center text-white h-64">
          ...
          {/* Box 4: Legal Image */}
          <div className="bg-blue-50 rounded-2xl overflow-hidden h-64 relative">
          ...
          {/* Box 6: Income Tax */}
          <div className="p-8 rounded-2xl flex flex-col justify-center text-white h-64 relative overflow-hidden" style={{ backgroundColor: TEAL }}>
          ...
          {/* Box 8: Legal Support */}
          <div className="bg-gray-200 p-8 rounded-2xl flex flex-col justify-center h-64">
            <div className="mb-4">
